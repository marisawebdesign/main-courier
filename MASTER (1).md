# Danforth Delivers — Master Project Document
...
| Notifications | Twilio (transactional) + GHL (marketing) | SMS ordering, verifications, delivery updates, broadcasts |
...
|---|---------|----------|--------|
| 1 | First-Time Onboarding & Signup | [specs/C-01-onboarding.md](specs/C-01-onboarding.md) | ✅ Specified (v1.1) |
| 2 | Home Screen & Navigation | [specs/C-02-home-navigation.md](specs/C-02-home-navigation.md) | ✅ Specified (v3.0) |
| 3 | Product Browsing & Search | features/03-product-browsing.md | 🔲 Not started |
| 4 | Cart & Checkout Flow | features/04-cart-checkout.md | 🔲 Not started |
| 5 | Reordering & Standing Orders | features/05-reordering.md | 🔲 Not started |
| 6 | Community & Route Building | [specs/C-06-community-routes.md](specs/C-06-community-routes.md) | ✅ Specified (v2.0) |
...
- `item_aliases` — Fuzzy matching dictionary for freeform shopping list deduplication
...
| GHL (marketing, existing sub) | $0 incremental |
